...
public class ParticipationService {
  ...
  public ParticipationResponse approve(AuthUser authUser, Long gatheringId, Long participationId) {
    Gathering gathering = getGatheringForUpdate(gatheringId);
  ...
  private Gathering getGatheringForUpdate(Long gatheringId) {
    Gathering gathering = getGathering(gatheringId);
    entityManager.lock(gathering, LockModeType.PESSIMISTIC_WRITE);
    return gathering;
  }
